  ...
  return (
    <Container>
      ...
      <Section>
        ...
        <Content>
          한로로 팬사이트(이하 "본 사이트")는 다음의 목적을 위하여 개인정보를
        ...
        <List>
          <ListItem>
            회원 가입 및 관리: Google 계정을 통한 회원 식별, 본인 확인
          </ListItem>
          <ListItem>
            게시판 서비스 제공: 게시글 및 댓글 작성자 식별, 닉네임 표시
          </ListItem>
      ...
      <Section>
        ...
        <List>
          <ListItem>
            <Strong>필수 항목:</Strong> Google 이름, 이메일 주소, 프로필 이미지,
            Google ID
          </ListItem>
          <ListItem>
            <Strong>선택 항목:</Strong> 닉네임 (사용자가 직접 설정)
          </ListItem>
          <ListItem>
            <Strong>자동 수집 항목:</Strong> 마지막 로그인 시간
          </ListItem>
        </List>
        <Content>
          위 정보는 Google 로그인 시 Google로부터 제공받으며, 본 사이트는
          추가적인 개인정보를 직접 수집하지 않습니다.
        </Content>
      </Section>
      ...
      <Section>
        ...
        <Content>
          본 사이트는 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터
        ...
        <List>
          ...
          <ListItem>
            <Strong>게시글 및 댓글:</Strong> 회원 탈퇴 후에도 게시판 운영을 위해
            보존될 수 있으며, 작성자 정보는 익명 처리됩니다
          </ListItem>
        </List>
      </Section>
      ...
      <Section>
        ...
        <Content>
          본 사이트는 정보주체의 개인정보를 제1조(개인정보의 처리 목적)에서
      ...
      <Section>
        ...
        <Content>
          본 사이트는 원활한 서비스 제공을 위해 다음과 같이 개인정보 처리업무를
          위탁하고 있습니다:
        </Content>
        <List>
          <ListItem>
            <Strong>Google (Google LLC):</Strong> 로그인 인증 처리
          </ListItem>
          <ListItem>
            <Strong>MongoDB (MongoDB, Inc.):</Strong> 데이터베이스 호스팅 및
            관리
          </ListItem>
          <ListItem>
            <Strong>Vercel (Vercel Inc.):</Strong> 웹 호스팅 및 서버 운영
          </ListItem>
        </List>
      </Section>
      ...
      <Section>
        ...
        <Content>
          위 권리 행사는 마이페이지에서 직접 수정하거나, 본 사이트 관리자에게
          이메일로 요청하실 수 있습니다.
        </Content>
      </Section>
      ...
      <Section>
        ...
        <List>
          <ListItem>
            <Strong>파기 절차:</Strong> 회원 탈퇴 요청 시 즉시 파기
          </ListItem>
          <ListItem>
      ...
      <Section>
        ...
        <List>
          <ListItem>
            개인정보 암호화: 비밀번호는 암호화되어 저장 및 관리
          </ListItem>
          <ListItem>
            해킹 등에 대비한 기술적 대책: 보안프로그램을 설치하고 주기적으로
            갱신·점검
          </ListItem>
          <ListItem>
            접근 제한: 개인정보처리시스템에 대한 접근권한을 최소한의 인원으로
            제한
          </ListItem>
        </List>
      </Section>
      ...
      <Section>
        ...
        <Content>
          본 사이트는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보
          처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이
          개인정보 보호책임자를 지정하고 있습니다.
        </Content>
        <ContactBox>
          <ContactItem>
            <Strong>개인정보 보호책임자:</Strong> 한로로 팬사이트 관리자
          </ContactItem>
          <ContactItem>
            <Strong>이메일:</Strong> khs39200@gmail.com
          </ContactItem>
        </ContactBox>
      </Section>
      ...
      <Section>
        ...
        <Content>
          이 개인정보처리방침은 2025년 2월 20일부터 적용되며, 법령 및 방침에
      ...
      <Section>
        ...
        <Content>
          본 사이트는 Google OAuth 2.0을 사용하여 로그인 기능을 제공합니다.
          Google 로그인 시 Google의 개인정보처리방침이 적용되며, 본 사이트는
          Google로부터 제공받은 최소한의 정보(이름, 이메일, 프로필 이미지)만을
          수집합니다.
        </Content>
        <Content>
          Google의 개인정보처리방침은{" "}
